terraform {
  ...
  backend "s3" {
    bucket         = "remote-tf-state-eks-infra-a66c5baf"
    region = "eu-west-3"
...
# ---------------- EKS Cluster ----------------
# NOTE: cluster_version is intentionally NOT set.
# AWS will create the cluster using the latest supported EKS version.
module "eks" {
